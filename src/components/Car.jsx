  ...
  return (
    <div>
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:pt-56">
            <h2 class="font-urbanist mb-4 text-5xl tracking-tight font-medium leading-none text-gray-900 md:text-5xl lg:text-5xl dark:text-white justify-center">Discover our furniture collection</h2>
                <p class="my-4 text-lg justify-center text-gray-500">Don't just take our word for it - see what actual users of our service have to say about their experience.</p>
